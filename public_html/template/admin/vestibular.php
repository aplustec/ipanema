...
<div id="container2">
  <div id="title">P&aacute;gina Vestibular</div>
  <div id="formulario">
      <form id="form1" name="form1" method="post" action="">
    <table width="1019" border="0">
      <tr>
        <td height="30" valign="bottom" class="label">T&iacute;tulo da p&aacute;gina</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" valign="bottom"><label for="descricao">
          <input name="url" type="text" class="input" id="url" />
        </label></td>
      </tr>
      <tr>
        <td height="30" valign="bottom"><span class="label">Imagem</span></td>
      </tr>
      <tr>
        <td><input name="image1" type="file" id="image1" />
        <label><em><span class="info">(750 x 500px Arquivo - JPG) <strong>M&aacute;ximo 24 imagens</strong></span></em></label></td>
      </tr>
      <tr>

...
<div id="container2">
  <div id="title">&Aacute;lbuns</div>
  <div id="ordenacao"><a href="cad-album.php" class="anunciante"><strong>+ novo &aacute;lbum</strong></a></div>
<div id="albuns">
 <ul class="galeria">
      <li>
        <div id="image-galeria"><a href="edit-album.php"><img src="../imagens/galeria/gal1/img01.jpg" width="226" height="150" border="0" title="Editar álbum" /></a></div>
        <div id="detail-galeria">T&iacute;tulo do &aacute;lbum</div>
        <div id="actions-galeria"><a href="edit-album.php"><img src="imagens/edit-icon.png" width="20" height="20" border="0" title="Editar álbum" /></a><a href="#"><img src="imagens/del.png" width="25" height="20" border="0" title="Excluir álbum" /></a></div>
      </li>
      <li>
        <div id="image-galeria"><a href="edit-album.php"><img src="../imagens/galeria/gal1/img01.jpg" width="226" height="150" border="0" title="Editar álbum" /></a></div>
        <div id="detail-galeria">T&iacute;tulo do &aacute;lbum</div>

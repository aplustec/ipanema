    ...
    <table width="1019" border="0">
      ...
      <tr>
        <td height="30" valign="bottom"><label for="descricao"></label>
          <textarea name="descricao" cols="45" rows="5" class="area2" id="descricao">Neste vídeo, a Diretora Acadêmica Nadir Nunes fala sobre a preocupação da Faculdade Ipanema em formar pessoas que busquem soluções para os problemas enfrentados pela sociedade. Ela reforça a inovação como principal valor da instituição e reafirma seu papel de formar verdadeiros líderes, mostrando por que a Ipanema é a melhor escolha para o seu futuro.
          </textarea> 

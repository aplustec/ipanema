...
<div id="container2">
  <div id="title">Cadastrar nova not&iacute;cia</div>
  <div id="formulario">
    <br />
    ...
    <table width="817" border="0">
      ...
      <tr>
        <td><label for="titulo"></label><input name="titulo" type="text" class="input" id="titulo" /></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" valign="bottom"><label for="texto"></label>
          <textarea name="texto" cols="45" rows="5" class="area" id="texto"></textarea></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><input name="image1" type="file" id="image1" />
          <label><em><span class="info">(350 x 350px - JPG)</span></em></label></td>
      </tr>
      <tr>

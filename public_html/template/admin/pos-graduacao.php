...
<div id="container2">
  <div id="title">Cursos P&oacute;s-Gradua&ccedil;&atilde;o</div>
  <div id="ordenacao">

      <table width="1030" border="0" align="right">
        <tr>
          <td width="824"><a href="cad-pos.php" class="anunciante">+ novo curso</a></td>
          <td width="92">&nbsp;</td>
          <td width="100"></td>
...
<div id="vitrine3">
  <table width="653" border="0" cellpadding="7" cellspacing="4">
    <tr>
      <td width="538" class="label">&nbsp;</td>
      <td width="75" class="label">&nbsp;</td>
    </tr>
    <tr>
      <td><span class="label">Curso</span></td>
      <td><span class="label">A&ccedil;&otilde;es</span></td>
    </tr>
    <tr>
      <td height="45" bgcolor="#FFFFFF"><h3 class="info">MBA em Redes Sociais e Inova&ccedil;&atilde;o Digital</h3></td>
      <td bgcolor="#FFFFFF"><a href="edit-cursopos.php"><img src="imagens/edit-icon.png" width="20" height="20" border="0" title="Editar" /></a> <a href="#"><img src="imagens/del.png" width="25" height="20" border="0" title="Excluir" /></a></td>
    </tr>
    <tr>
      <td height="45"><h3 class="info">MBA em Mercado de Capitais</h3></td>
      <td><a href="edit-cursopos.php"><img src="imagens/edit-icon.png" width="20" height="20" border="0" title="Editar" /></a> <a href="#"><img src="imagens/del.png" width="25" height="20" border="0" title="Excluir" /></a></td>
    </tr>
    <tr>
      <td height="45" bgcolor="#FFFFFF"><h3 class="info">MBA em Redes Sociais e Inova&ccedil;&atilde;o Digital</h3></td>
      <td bgcolor="#FFFFFF"><a href="edit-cursopos.php"><img src="imagens/edit-icon.png" width="20" height="20" border="0" title="Editar" /></a> <a href="#"><img src="imagens/del.png" width="25" height="20" border="0" title="Excluir" /></a></td>

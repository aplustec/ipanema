...
/**
 * The Abstract Class to use in controllers of admin module for set all common params and configurations of controllers
 * 
 * @category App
 * @package App/Modules
 * @subpackage Admin
...
abstract class App_Modules_Admin_Abstract extends Zend_Controller_Action
{
	/**
	...
	/**
	 * This is a method to verify if user has logged in system
	 * 
	 * @return boolean
	 */
	function isLogged()
	...
	/**
	 * This is method to lock controllers and actions for unauthorized access
	 */
	function lock()
	{
		if(!$this->isLogged())

...
abstract class App_Modules_Default_Abstract extends Zend_Controller_Action
{
	...
	function abstractInit()
	{
		...
		/* Initializing components for render banner */
		$this->menuContentInit();
	}
	/**
	...
	function menuContentInit()
	{
		...
		/* Getting data and setting in view */
		$this->view->graduationCourses = $graduation->fetchAll(null,"name");
		$this->view->posgraduationCourses = $posgraduation->fetchAll(null,"name");
		$this->view->extensionCourses = $course->fetchAll(null,"name");
	}
	/**
